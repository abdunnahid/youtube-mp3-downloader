...
``` bash
git clone https://github.com/abdunnahid/youtube-mp3-downloader.git
```
...
The application code is managed by `main.ts`. In this sample, the app runs with a simple Angular App (http://localhost:5500) and an Electron window.
